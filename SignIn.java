...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnlogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 490, 110, 40));
        ...
        signup.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        ...
        getContentPane().add(signup, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 490, 120, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 490, -1, 40));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/88.jpg"))); // NOI18N
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try {
            pst=c.prepareStatement("SELECT * FROM library.login where emailid=? AND password=?");
